...
def parse_args():
    ...
    parser.add_argument('--data', default='programmable-web', type=str, help='name of dataset')
    parser.add_argument('--dropout', default=0.5, type=float, help='rate for edge dropout')
