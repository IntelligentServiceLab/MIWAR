...
class LightGCL(nn.Module):
    def __init__(self, n_u, n_i, d, u_mul_s, v_mul_s, ut, vt, train_csr, adj_norm, l, temp, lambda_1, lambda_2, dropout, batch_user, device,input_dim=None,hidden_dim=None,out_dim=None):
    ...
    def forward(self, uids, pos, neg, test=False,pos_api_emb=None,neg_api_emb=None,mashup_emb=None):
